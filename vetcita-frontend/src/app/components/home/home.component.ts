...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gradient-to-br from-sky-100 via-white to-sky-50 text-slate-900 font-sans selection:bg-sky-200">
      <div class="mx-auto max-w-7xl px-5 py-8 sm:px-8 lg:px-10">
        ...
        <header class="rounded-[30px] border border-white/60 bg-white/60 px-6 py-4 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-md flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between transition-all">
          <div class="flex items-center gap-4">
            <div class="flex h-12 w-12 items-center justify-center rounded-[18px] bg-gradient-to-br from-sky-500 to-sky-700 text-xl font-bold text-white shadow-md shadow-sky-500/30">
              V
            </div>
            <div>
        ...
        <main class="mt-12 sm:mt-20">
          <div class="mx-auto max-w-4xl text-center">
            ...
            <h1 class="mt-8 text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-slate-900 to-slate-700 tracking-tight sm:text-6xl leading-[1.15]">
          ...
          <div class="mt-24 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="group rounded-[32px] border border-white/60 bg-white/80 p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-sm transition hover:shadow-[0_8px_30px_rgb(14,165,233,0.1)] hover:-translate-y-1">
            ...
            <div class="group rounded-[32px] border border-white/60 bg-white/80 p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-sm transition hover:shadow-[0_8px_30px_rgb(16,185,129,0.1)] hover:-translate-y-1">
            ...
            <div class="group rounded-[32px] border border-white/60 bg-white/80 p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-sm transition hover:shadow-[0_8px_30px_rgb(245,158,11,0.1)] hover:-translate-y-1 sm:col-span-2 lg:col-span-1">
