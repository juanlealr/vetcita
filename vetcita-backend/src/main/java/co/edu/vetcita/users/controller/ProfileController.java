...
public class ProfileController {
    ...
    public ResponseEntity<String> changePassword(
        ...
        profileService.changePassword(currentUser.getId(), dto.getCurrentPassword(), dto.getNewPassword());
        return ResponseEntity.ok("Contraseña actualizada correctamente");
    }

    @PostMapping("/me/deactivate")
    public ResponseEntity<String> deactivateMe(@AuthenticationPrincipal User currentUser) {
        profileService.deactivateAccount(currentUser.getId());
        return ResponseEntity.ok("Cuenta desactivada correctamente.");
    }

    @DeleteMapping("/me")
    public ResponseEntity<String> deleteMe(@AuthenticationPrincipal User currentUser) {
        profileService.deleteUser(currentUser.getId());
