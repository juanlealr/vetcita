...
public class AuthService {
    ...
    public AuthResponseDTO register(RegisterRequestDTO request) {
        ...
        try {
            idType = IdentificationType.valueOf(request.getIdentificationType().toUpperCase());
        } catch (IllegalArgumentException | NullPointerException e) {
            throw new RuntimeException("Tipo de documento inválido: " + request.getIdentificationType());
        }
