...
public class AppointmentService {
    ...
    private AppointmentResponseDTO mapToDTO(Appointment appointment) {
        ...
        String ownerName = userServiceApi.getFullName(appointment.getClientId());
    ...
    public DashboardMetricsDTO getAdminDashboardMetrics() {
        ...
        List<AppointmentResponseDTO> citasHoyList = appointmentRepository
                .findByAppointmentDateAndStatusNot(LocalDate.now(), AppointmentStatus.CANCELLED)
                .stream()
                .map(this::mapToDTO)
                .collect(Collectors.toList());
